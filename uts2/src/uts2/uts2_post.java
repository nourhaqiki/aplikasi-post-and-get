...
public static void main(String[] args) {
	try {
	 ...
	 public static void call_me() throws Exception {
	    ...
	    params.put("name", "nour haqiki");
	    params.put("email", "makanbang@gmail.com");
	    params.put("NPM", "06769");
	    ...
	    System.out.println("NPM- "+form_data.getString("NPM"));
